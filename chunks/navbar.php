<section class="fnavbar">
		...
		<nav>
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <?php
		        	...
		        	if (isset($_SESSION['user'])) {
						...
						<li><a href="order.php" class="hvr-grow">My Order</a></li>
						<li><a href="book_table.php" class="hvr-grow">Book Table</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
			...
			<li><a href="./admin/" class="hvr-grow">Admin</a></li>
	        <li><a href="/RES/about-restro-girls.php">About Us</a></li>
