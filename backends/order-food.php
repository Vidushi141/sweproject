...
$payment = $_GET['pay']. strval(mt_rand(100000, 999999));

$sql = "INSERT INTO orders(order_id,user_id,food_id,user_name, comment, payment,  timestamp) VALUES(?,?,?,?,?,?,?)";

$query  = $pdoconn->prepare($sql);

if ($query->execute([$order_id, $user_id, $food_id, $user_name, $comment, $payment,  $timest])) {
